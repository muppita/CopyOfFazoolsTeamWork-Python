...
claimroute_button = tk.Button(root, text = "  End Turn",font=("courier", 15),  command = root.quit, anchor = 'w',
...
howtoplay_button = tk.Button(root, text = "View Current Routes",font=("courier", 15),  command = root.quit, anchor = 'w',
                    width = 19,height = 1, activebackground = "#33B5E5")
