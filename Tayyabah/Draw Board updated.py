...
canvas.create_image(1525,450, image=image2,anchor = NE)
root.title('Loco Motive')

#option menu buttons hosting area
pickcarriagecard_button = tk.Button(root, text = " Carriage card",font=("courier", 15),  command = root.quit, anchor = 'w',width = 16,height = 2,
                       activebackground = "#33B5E5")
pickcarriagecard_button_window = canvas.create_window(1070, 180, anchor='nw', window=pickcarriagecard_button)    
pickroute_button = tk.Button(root, text = "   Route card",font=("courier", 15),  command = root.quit, anchor = 'w',
